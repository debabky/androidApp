...
object SecureSharedPrefs {
    private const val PREFS_FILE_NAME = "irpgeojk;flp[oioguhohuekfekfwekfp[opj"
    ...
    fun saveDG1(context: Context, dg1: String) {
        val sharedPreferences = getSharedPreferences(context)
        val editor = sharedPreferences.edit()
        editor.putString(tags["DG1"], dg1)
        editor.apply()
    }

    fun getDG1(context: Context): String? {
        val sharedPreferences = getSharedPreferences(context)
        return sharedPreferences.getString(tags["DG1"], "")
    }

    fun saveDG2(context: Context, dg2: String) {
        val sharedPreferences = getSharedPreferences(context)
        val editor = sharedPreferences.edit()
        editor.putString(tags["DG2"], dg2)
        editor.apply()
    }

    fun getDG2(context: Context): String? {
        val sharedPreferences = getSharedPreferences(context)
        return sharedPreferences.getString(tags["DG2"], "")
    }

    fun saveDG15(context: Context, dg15: String) {
        val sharedPreferences = getSharedPreferences(context)
        val editor = sharedPreferences.edit()
        editor.putString(tags["DG15"], dg15)
        editor.apply()
    }

    fun getDG15(context: Context): String? {
        val sharedPreferences = getSharedPreferences(context)
        return sharedPreferences.getString(tags["DG15"], "")
    }
    ...
    fun getSOD(context: Context): String? {
        val sharedPreferences = getSharedPreferences(context)
